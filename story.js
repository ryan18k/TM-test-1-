...
async function runGame(){
  ...
  SCENE_CAST = { 'Marc':{slot:'left',key:'marc'}, 'Thomas':{slot:'right',key:'thomas'} };
  stageShow('left','marc'); stageShow('right','thomas'); stageActivate('left');
  ...
  SCENE_CAST = { 'Marc':{slot:'left',key:'marc'}, 'Lucas':{slot:'right',key:'lucas'} };
  stageShow('left','marc'); stageHide('right'); stageActivate('left');
  ...
  stageShow('right','lucas'); stageActivate('right');
  ...
  SCENE_CAST = { 'Marc':{slot:'left',key:'marc'}, 'Antoine':{slot:'right',key:'antoine'} };
  stageShow('left','marc'); stageShow('right','antoine'); stageActivate('left');
  ...
  await fadeIn(400);
  stageShow('left','marc'); stageShow('right','antoine'); stageActivate('right');
  sceneEl.classList.add('visible');
  ...
  stageShow('left','marc'); stageActivate('left');
